 ...
 */
final class Version20240228181835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE basket (id INT AUTO_INCREMENT NOT NULL, products_id INT NOT NULL, purchases_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_2246507B6C8A81A9 (products_id), INDEX IDX_2246507B559939B3 (purchases_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, aroma_id INT NOT NULL, nicotine_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, detail LONGTEXT DEFAULT NULL, reference VARCHAR(255) NOT NULL, INDEX IDX_D34A04AD800E3C79 (aroma_id), INDEX IDX_D34A04ADACD4548B (nicotine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADACD4548B FOREIGN KEY (nicotine_id) REFERENCES nicotine (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04ADACD4548B');
